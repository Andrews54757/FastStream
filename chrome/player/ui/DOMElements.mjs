export const DOMElements = {
  ...
  hudContainer: document.querySelector('.mainplayer .fs_hud'),
  playPausePopup: document.querySelector('.mainplayer .fs_playpause_popup'),
  seekPopupLeft: document.querySelector('.mainplayer .fs_seek_popup_left'),
  seekPopupLeftText: document.querySelector('.mainplayer .fs_seek_popup_left .fs_seek_text'),
  seekPopupRight: document.querySelector('.mainplayer .fs_seek_popup_right'),
  seekPopupRightText: document.querySelector('.mainplayer .fs_seek_popup_right .fs_seek_text'),
