...
function getMediaNameFromTab(tab) {
    ...
    let wordsToExclude = ["tv","movie","hd","full","free","online","stream","streaming","watch","now","watching","episode","season","series","anime","show","shows","episodes","seasons","part","parts","sub","dub","subdub","subbed","dubbed","english","subtitles","subtitle"]; 
