...
"extension_name": "Video Player",
  ...
  "welcome_page_usage_content1": "You can go to a website with a video stream, and turn FFS on by clicking on the icon. Play the stream and the client will be auto-replaced with FFS",
  ...
  "welcome_page_usage_end": "Thank you for installing FFS! Please let us know if you have any issues or suggestions.",
  ...
  "perms_page_title": "FFS Permissions",
  "perms_page_about_header": "About the Permissions Required by FFS",
  ...
  "perms_page_breakdown_perm1d": "FFS needs to be able to access all websites so that it can inject the player into the website directly. It injects a content script into websites you visit in order to:",
  ...
  "player_settings_title": "FFS Settings",
  ...
  "player_welcometext": "Welcome to FFS v$1!",
  ...
  "options_promo_rate": "OK I'll review FFS",
